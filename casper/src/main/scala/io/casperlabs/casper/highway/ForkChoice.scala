...
object ForkChoice {
  ...
  def create[F[_]: Sync: EraStorage: DagStorage: MessageAncestorsStorage]: ForkChoice[F] =
    new ForkChoice[F] {
...
object ForkChoiceManager {
  def create[F[_]: Sync: EraStorage: DagStorage: MessageAncestorsStorage]: ForkChoiceManager[F] = {
